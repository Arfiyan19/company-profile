  ...
  <header id="header">
    <div class="container">
      ...
      <div id="logo" class="pull-left">
        <a href="#hero">
          <img src="{{asset('user/images/1.png')}}" style="margin-right:5px;width: 50px; font-family: 'Franklin Gothic Medium';"/></img>
          <!-- /user/images/ -->
          <h2 style="font-size: 20px;" class="d-inline text-light">creative-8</h2>
        </a>
      </div>
...
<!-- / -->
          <li class="{{$url=='blog'?'menu-active':''}}"><a href="{{url('blog')}}">Price</a></li>
          <li class="{{$url=='destination'?'menu-active':''}}"><a href="{{url('destination')}}">People</a></li>
          <li class="{{$url=='contact'?'menu-active':''}}"><a href="{{url('contact')}}">Recruit </a></li>
